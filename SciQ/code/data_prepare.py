...
class prepare_data():
    def __init__(self,word2vec_path,processed_data_path,word_vec_size,max_q_length,max_option_length,max_opt_count,max_sent_para,max_words_sent):
        if not os.path.exists(processed_data_path):
            g_network_ready_files = generate_network_ready_files(word2vec_path,os.path.dirname(processed_data_path),word_vec_size,max_q_length,max_option_length,max_opt_count,max_sent_para,max_words_sent)
